    ...
    Markdown({
      ...
      async markdownItSetup(md) {
        ...
        md.use(MarkdownItMagicLink, {
          linksMap: {
            ...
            'YBX Labs': { link: 'https://yesbhautikx.co.in', imageUrl: 'https://res.cloudinary.com/dl9rorn1z/image/upload/v1744634858/Static/YBX%20Labs/Logo/SVG/lapucduwsoyfpdzsrpx4.svg' },
          ...
          imageOverrides: [
            ...
            ['https://github.com/sponsors/yesbhautik', 'https://github.com/github.png'],
      ...
      frontmatterPreprocess(frontmatter, options, id, defaults) {
        (() => {
          ...
          frontmatter.image = `https://yesbhautik.co.in/${path}`
        })()
