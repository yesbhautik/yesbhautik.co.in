...
const base = 'https://yesbhautik.co.in'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @yesbhautik\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading @yesbhautik@fosstodon.org\'s ${base}${route.path}\n\nI think...`)}`)
const blueskyUrl = computed(() => `https://bsky.app/intent/compose?text=${encodeURIComponent(`Reading @yesbhautik.co.in ${base}${route.path}\n\nI think...`)}`)
